...
static int gmac_nua3500_ofdata_to_platdata(struct udevice *dev)
{
	struct gmac_nua3500_platdata *pdata = dev_get_platdata(dev);
...
static int gmac_nua3500_probe(struct udevice *dev)
{
	struct gmac_nua3500_platdata *pdata = dev_get_platdata(dev);
...
static int nua3500_read_rom_hwaddr(struct udevice *dev)
{
	struct gmac_nua3500_platdata *pdata = dev_get_platdata(dev);
...
const struct eth_ops gmac_nua3500_eth_ops = {
	...
	.read_rom_hwaddr	= nua3500_read_rom_hwaddr,
};

static const struct udevice_id nua3500_gmac_ids[] = {
	{ .compatible = "nuvoton,nua3500-gmac" },
	{ }
};

U_BOOT_DRIVER(eth_gmac_nua3500) = {
	.name	= "gmac_nua3500",
	.id	= UCLASS_ETH,
	.of_match = nua3500_gmac_ids,
	.ofdata_to_platdata = gmac_nua3500_ofdata_to_platdata,
	.probe	= gmac_nua3500_probe,
	.ops	= &gmac_nua3500_eth_ops,
	.priv_auto_alloc_size = sizeof(struct dw_eth_dev),
	.platdata_auto_alloc_size = sizeof(struct gmac_nua3500_platdata),
