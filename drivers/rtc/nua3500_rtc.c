 ...
 * get time
 *****************************************************************************/
int nua3500_rtc_get(struct udevice *dev, struct rtc_time *tmp)
{
 ...
 * set time
 *****************************************************************************/
int nua3500_rtc_set(struct udevice *dev, const struct rtc_time *tmp)
{
	struct nua3500_rtc_priv *priv = dev_get_priv(dev);
	uint32_t val = readl(priv->base + REG_RTC_INIR);
	int ret;
 ...
 * reset rtc
 *****************************************************************************/
static int nua3500_rtc_reset(struct udevice *dev)
{
...
static const struct rtc_ops nua3500_rtc_ops = {
	.get = nua3500_rtc_get,
	.set = nua3500_rtc_set,
	.reset = nua3500_rtc_reset,
};

static const struct udevice_id nua3500_rtc_ids[] = {
...
U_BOOT_DRIVER(rtc_nuvoton) = {
	...
	.of_match = nua3500_rtc_ids,
	.ops	= &nua3500_rtc_ops,
	.priv_auto_alloc_size = sizeof(struct nua3500_rtc_priv),
};
