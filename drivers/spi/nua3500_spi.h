...
#ifndef _NUA3500_SPI_H_
#define _NUA3500_SPI_H_

#if defined(CONFIG_USE_NUA3500_QSPI0)
#define SPI_BASE 0x40680000 //QSPI0
#elif defined(CONFIG_USE_NUA3500_QSPI1)
#define SPI_BASE 0x40690000 //QSPI1
#elif defined(CONFIG_USE_NUA3500_SPI0)
#define SPI_BASE 0x40600000 //SPI0
#elif defined(CONFIG_USE_NUA3500_SPI1)
#define SPI_BASE 0x40610000 //SPI1
#elif defined(CONFIG_USE_NUA3500_SPI2)
#define SPI_BASE 0x40620000 //SPI2
#elif defined(CONFIG_USE_NUA3500_SPI3)
...
struct nua3500_spi_slave {
	struct spi_slave slave;
	unsigned int max_hz;
	unsigned int mode;
};

static inline struct nua3500_spi_slave *to_nua3500_spi(struct spi_slave *slave) {
	return container_of(slave, struct nua3500_spi_slave, slave);
}

#endif //_NUA3500_SPI_H_
