...
#ifndef __DRIVERS_CLK_NUVOTON_CLK_NUA3500_H
#define __DRIVERS_CLK_NUVOTON_CLK_NUA3500_H
...
struct __nua3500_clk_sel_type_map {
	u32 muxMap[4];
};

struct __nua3500_clk_gate_data {
	u32 type;
	ulong rate;
	u32 offst;
	u32 bitIdx;
...
struct ___nua3500_clk_reg_info {
	struct __nua3500_clk_gate_data clkGate;
	struct __nua3500_clk_mux_data  clkMux;
	struct __nua3500_clk_div_data  clkDiv;
};


enum nua3500_pll_type {
	NUA3500_CAPLL,
	NUA3500_SYSPLL,
	NUA3500_DDRPLL,
	NUA3500_APLL,
...
static struct __nua3500_clk_sel_type_map __clk_sel_type_tbl[] = {
...
static struct __nua3500_wrpll_data __nua3500_capll_data = {
	.plltype = 0,
...
static struct __nua3500_wrpll_data __nua3500_syspll_data = {
	.plltype = 1,
...
static struct __nua3500_wrpll_data __nua3500_ddrpll_data = {
	.plltype = 2,
...
static struct __nua3500_wrpll_data __nua3500_apll_data = {
	.plltype = 3,
...
static struct __nua3500_wrpll_data __nua3500_epll_data = {
	.plltype = 4,
...
static struct __nua3500_wrpll_data __nua3500_vpll_data = {
	.plltype = 5,
...
static struct __nua3500_clk_gate_data __clk_id_gate_sets[] = {
...
static struct __nua3500_clk_mux_data __clk_id_mux_sets[] = {
...
static struct __nua3500_clk_div_data __clk_id_div_sets[] = {
