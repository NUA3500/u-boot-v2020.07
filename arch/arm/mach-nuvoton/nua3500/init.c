...
#define NUA3500_REGION_DDR	0
#define NUA3500_REGION_REG	1
...
int dram_init_banksize(void)
{
	...
	mem_map[NUA3500_REGION_DDR].virt = gd->ram_base;
	mem_map[NUA3500_REGION_DDR].phys = gd->ram_base;
	mem_map[NUA3500_REGION_DDR].size = gd->ram_size;
